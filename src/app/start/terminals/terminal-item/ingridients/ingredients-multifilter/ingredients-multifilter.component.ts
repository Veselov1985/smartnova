import { Component, OnInit, ViewChild, Output, ElementRef, EventEmitter, SimpleChanges, OnChanges, Input } from '@angular/core';
...
export class IngredientsMultifilterComponent implements OnInit, OnChanges {
